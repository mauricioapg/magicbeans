...
return array(
    ...
    'You will be redirected to Santander´s webpage for credit application after placing order.' => 'You will be redirected to Santander´s webpage for credit application after placing order.',
