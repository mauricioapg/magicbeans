...
return array(
    ...
    // Checkout
    'Monthly instalment' => 'Delbetalning',
    'You will be redirected to Santander´s webpage for credit application after placing order.' => 'Du kommer att skickas till Santanders hemsida för kreditansökan när du har placerat din order.',
